...
- In another terminal navigate to file-demo1 folder (can use ```cd file-demo1```), and run this command: ```npm run start```. This will start running the frontend in [http://localhost:3000](http://localhost:3000).
